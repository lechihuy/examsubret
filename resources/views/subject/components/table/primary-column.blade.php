<td class="cell-fixed primary-cell" style="left: 48px;">
    <div class="d-flex">
        ...
        data-toggle="collapse" data-target="#collapse-cell-{{ $subject->id }}">
    ...
    {{-- Data toggle --}}
    <div class="collapse d-md-none w-100" id="collapse-cell-{{ $subject->id }}">
        ...
        <div>
            {{-- Action --}}
            <a href="{{ route('majors.edit', $subject->id) }}" class="mr-3">Sửa</a>
        </div>
        {{-- /Action --}}
