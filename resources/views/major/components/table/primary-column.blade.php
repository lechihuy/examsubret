<td class="cell-fixed primary-cell" style="left: 48px;">
    <div class="d-flex">
        <a href="{{ $link }}">{{ $major->name }}</a>

        {{-- Button toggle --}}
        <span class="ml-auto d-inline-block d-md-none toggle-cell pl-2" 
        data-toggle="collapse" data-target="#collapse-cell-{{ $major->id }}">
    ...
    {{-- Data toggle --}}
    <div class="collapse d-md-none w-100" id="collapse-cell-{{ $major->id }}">
        ...
        <div>
            {{-- Action --}}
            <a href="{{ route('majors.edit', $major->id) }}" class="mr-3">Sửa</a>
        </div>
        {{-- /Action --}}
