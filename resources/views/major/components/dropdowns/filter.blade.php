...
<div id="overlay-filter" class="overlay bg-white shadow text-left px-3 py-2 d-none">
    ...
    <form class="py-2" id="form-filter">   
        <div class="form-group input-group-sm">
            <label class="font-weight-bold">Tên ngành</label>
            <input type="text" class="form-control" name="name" value="{{ $filter['name'] ?? '' }}">
        </div>

        <div class="form-group input-group-sm">
            <label class="font-weight-bold">Mã ngành</label>
        ...
        <a href="{{ route('majors.index') }}" class="btn btn-sm btn-light"><i class="fas fa-sync-alt"></i> Khôi phục</a>
